...
export const MILITARY_ARTICLES: Article[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      {
        type: "map-highlight",
        title: "Carte des livraisons de chars à l'Ukraine — 2022–2024",
        subtitle: "Pays fournisseurs de blindés lourds identifiés (chars de combat principaux)",
        countries: {
          DE: { color: "#27AE60", label: "Allemagne — 125 Leopard 2" },
          PL: { color: "#27AE60", label: "Pologne — 250+ T-72/Leopard" },
          US: { color: "#2980B9", label: "USA — 31 M1 Abrams" },
          GB: { color: "#8E44AD", label: "UK — 14 Challenger 2" },
          FR: { color: "#E67E22", label: "France — 18 AMX-10 RC" },
          CZ: { color: "#27AE60", label: "Rép. tchèque — T-72" },
          SK: { color: "#27AE60", label: "Slovaquie — T-72" },
          NL: { color: "#27AE60", label: "Pays-Bas — Leopard 2" },
          PT: { color: "#27AE60", label: "Portugal — Leopard 2A6" },
          DK: { color: "#27AE60", label: "Danemark — Leopard 2" },
          ES: { color: "#27AE60", label: "Espagne — Leopard 2A4" },
          NO: { color: "#27AE60", label: "Norvège — Leopard 2" },
          CA: { color: "#2980B9", label: "Canada — Leopard 2" },
          AU: { color: "#2980B9", label: "Australie — ASLAV" },
          RU: { color: "#C0392B", label: "Russie — T-72/T-80/T-90 (adversaire)" },
          UA: { color: "#F39C12", label: "Ukraine — théâtre des opérations" },
        },
        legend: [
          { color: "#27AE60", label: "Fournisseurs européens" },
          { color: "#2980B9", label: "USA / alliés pacifiques" },
          { color: "#8E44AD", label: "Royaume-Uni" },
          { color: "#E67E22", label: "France" },
          { color: "#F39C12", label: "Ukraine — zone de combat" },
          { color: "#C0392B", label: "Russie — adversaire" },
        ],
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      {
        type: "carousel",
        title: "Les flottes majeures de la région Indo-Pacifique",
        items: [
          { name: "Marine chinoise", emoji: "🇨🇳", detail: "727 navires", subdetail: "1ère flotte mondiale en nombre. Inclut 3 porte-avions, 60+ sous-marins, 50 destroyers. Croissance explosive : +200 navires en 10 ans." },
          { name: "US Navy Pacifique", emoji: "🇺🇸", detail: "200+ navires en zone", subdetail: "7e et 3e Flottes. 4-5 porte-avions déployables. Supériorité qualitative : F-35C, Arleigh Burke, Virginia-class SSN." },
          { name: "Marine japonaise (JMSDF)", emoji: "🇯🇵", detail: "155 navires", subdetail: "4 'quasi-porte-avions' Izumo. Sous-marins Taigei ultra-silencieux. Alliance US renforcée depuis 2022." },
          { name: "Marine australienne (RAN)", emoji: "🇦🇺", detail: "48 navires", subdetail: "AUKUS : 3-5 sous-marins nucléaires américains Virginia dès 2027. Premier pays non-américain à accéder à la tech SSN." },
          { name: "Marine taiwanaise", emoji: "🇹🇼", detail: "26 navires majeurs", subdetail: "Stratégie asymétrique : missiles Hsiung Feng III, mines navales, corvettes rapides. Objectif : anti-accès dans le détroit." },
          { name: "Marine indienne (IN)", emoji: "🇮🇳", detail: "130+ navires", subdetail: "INS Vikrant : 1er porte-avions construit en Inde. Garde l'océan Indien. Rival régional de la Chine." },
        ],
      },
      {
        type: "comparison-table",
