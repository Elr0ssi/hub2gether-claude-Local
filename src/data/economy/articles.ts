    ...
    body: [
      ...
      },
      {
        ...
        countries: {
          ...
          IT: { color: "#E74C3C", label: "Italie 137%" },
          SG: { color: "#E74C3C", label: "Singapour 134%" },
          US: { color: "#E67E22", label: "USA 123%" },
          FR: { color: "#E67E22", label: "France 113%" },
          BE: { color: "#E67E22", label: "Belgique 105%" },
          ES: { color: "#F39C12", label: "Espagne 107%" },
          PT: { color: "#F39C12", label: "Portugal 98%" },
          CA: { color: "#F39C12", label: "Canada 103%" },
          GB: { color: "#F39C12", label: "UK 97%" },
          IN: { color: "#F1C40F", label: "Inde 83%" },
          AU: { color: "#2ECC71", label: "Australie 49%" },
          DE: { color: "#27AE60", label: "Allemagne 64%" },
          CH: { color: "#1ABC9C", label: "Suisse 39%" },
          NO: { color: "#1ABC9C", label: "Norvège 33%" },
          NZ: { color: "#27AE60", label: "N-Zélande 47%" },
        },
        legend: [
