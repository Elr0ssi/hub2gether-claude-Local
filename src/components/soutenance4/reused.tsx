...
/* ═══════════════════════════════════════════════════════════════════════════
   ...
   ce fichier ne fait que les re-exporter sous les noms de la V4, pour que le
   ...
   la V4 présente ce que ce besoin débloque. Elle est donc réécrite ici, en
...
import { S4_UNLOCK } from "@/data/soutenance4/soutenance4Data";
...
/* Ces deux slides de la V2 affichent leur numéro de section : il vient de la
   ...
   liste de la V4 et non sur celle de la V2.

   La slide GEO, elle, a une variante propre à la V4 (voir slides.tsx) : le
